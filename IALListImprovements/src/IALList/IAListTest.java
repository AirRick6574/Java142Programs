...
/**
 * Test program for CS 143 Assignment 1 (Version of 4/15/2023)
 * You may only use this program as a student of David Anderson, CS 143 Spring 2023.
...
public class IAListTest {
	...
	public static void main(String[] args) {
		 System.out.println(
	                "=======================================================================================\n"+
	                "Tester for CS 143 Assignment 2: IAList Improvements\n"+
	                        "=======================================================================================\n"+
	                        ...
	                        "* Note that this assignment has a speed component. If your code provides accurate results\n\t"+
	                        "but is slow, the tester will indicate this with a message below.\n"+
	                "=======================================================================================\n"
	        );
		...
		try {
			...
			score += 8;
			System.out.println("OK. Now alternating addBefore and add with a bunch of values.");
			...
			System.out.println("OK. Now running a speed test alternating addBefore and add with 100,000 zeros.");
		 ...
		 System.out.println("\n");
	        ...
	        System.out.println("* Make sure your code has proper indentation and formatting. Doing CTRL+A and then \n\t CTRL+SHIFT+F in Eclipse will auto indent your code!");
	        System.out.println("* Be sure each method has a comment above it describing the purpose of that method.");
