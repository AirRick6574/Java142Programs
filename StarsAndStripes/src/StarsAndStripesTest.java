 ...
 * Modified by David Anderson for Spring 2021
...
public class StarsAndStripesTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("*** Accuracy score: " + totalScore + " / 100");
    System.out.println("This contributes " + totalScore * 0.7 + " points to your grade.");	
    System.out.println("The rest of your grade will depend on style.  See the rubric on Canvas.");
	}
