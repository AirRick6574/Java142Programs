...
public class ManagersCrossingTest {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println();		    
			...
			System.out.println("This will be multplied by some fraction to determine your grade.");
	    System.out.println("Additional points will be awarded for style. See the rubric in the Canvas assignment.");
      System.out.println("Lateness and academic dishonesty can also affect your score.");
		}
